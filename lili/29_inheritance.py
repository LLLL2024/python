...
# - 全职兼职都有"姓名 name"、 "工号 id"
#   都具备" 打印信息 print_info "(打印姓名、工号）方法。
# - 全职有" 月薪 monthly_salary"属性，
#   兼职有" 日薪 dali_salary"属性、 "每月工作天数 work_days"的属性。
...
class Employee:
    ...
    def print_info(self):
        print(f"员工名种子:{self.name}, 工号:{self.id}")

class FullTimeEmployee(Employee):
    def __init__(self, name, id_, monthly_salary):
...
class PartTimeEmployee(Employee):
    def __init__(self, name, id_, daily_salary, work_days):
        super().__init__(name, id_)
